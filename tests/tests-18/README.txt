...
Ce repertoire contien des fichiers pour le test du projet 
"Circuits et Architecture"

codage du processeur LC-3.
...
3) Ecrire un fichier avec le resultat attendu sous dans le
   ...
   Attention : il ne faut pas introduire une nouvelle ligne!
